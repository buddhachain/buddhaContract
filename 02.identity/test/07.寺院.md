...
xchain-cli wasm invoke identity --account XC1234567890100001@xuper --method approve_guaranty -a '{"id":"XC1234567890300001@xuper"}' --fee 1000000
...
xchain-cli wasm invoke identity --account XC1234567890100001@xuper --method recusal_guaranty -a '{"id":"XC1234567890300001@xuper"}' --fee 1000000
```
