...
xchain-cli wasm invoke audio --method list_guaranty_log -a '{"guarantyid":"XC1234567890300001@xuper"}' --account XC1234567890200001@xuper
xchain-cli wasm invoke audio --method list_guaranty_log --account XC1234567890300001@xuper

xchain-cli wasm invoke audio --method recusal_join_guaranty -a '{"guarantyid":"XC1234567890300001@xuper","logid":"XC1234567890400001@xuper"}' --account XC1234567890200001@xuper
```
