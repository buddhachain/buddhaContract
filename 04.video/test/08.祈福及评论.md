...
```bash
xchain-cli wasm invoke video --method add_commentlabel -a '{"id":"1", "desc":"处理及时"}' --account XC1234567890200001@xuper
xchain-cli wasm invoke video --method delete_commentlabel -a '{"id":"1"}' --account XC1234567890200001@xuper
xchain-cli wasm invoke video --method update_commentlabel -a '{"id":"1", "desc":"处理及时"}' --account XC1234567890200001@xuper
xchain-cli wasm invoke video --method find_commentlabel -a '{"id":"1"}' --account XC1234567890500001@xuper
xchain-cli wasm invoke video --method list_commentlabel --account XC1234567890200001@xuper
...
xchain-cli wasm invoke video --method find_beforecomment -a '{"kdid":"1","owner":"XC1234567890500001@xuper"}' --account XC1234567890200001@xuper
...
xchain-cli wasm invoke video --method list_beforecomment -a '{"kdid":"1"}' --account XC1234567890200001@xuper
...
xchain-cli wasm invoke video --method list_pray_kinddeed --account XC1234567890200001@xuper
...
xchain-cli wasm invoke video --method approve_kinddeedproof -a '{"orderid":"1"}' --account XC1234567890200001@xuper
xchain-cli wasm invoke video --method refuse_kinddeedproof -a '{"orderid":"1"}' --account XC1234567890200001@xuper
xchain-cli wasm invoke video --method find_kinddeedproof -a '{"orderid":"1"}' --account XC1234567890400001@xuper

xchain-cli wasm invoke video --method list_kinddeedproof --account XC1234567890200001@xuper
...
xchain-cli wasm invoke video --method list_aftercomment --account XC1234567890200001@xuper
...
xchain-cli wasm invoke video --method list_credit -a '{"id":"xxx"}' --account XC1234567890200001@xuper
xchain-cli wasm invoke video --method list_credit --account XC1234567890200001@xuper
...
xchain-cli wasm invoke video --method list_creditranking --account XC1234567890200001@xuper
xchain-cli wasm invoke video --method list_creditranking -a '{"id":""}' --account XC1234567890200001@xuper
xchain-cli wasm invoke video --method list_creditranking -a '{"id":"XC1234567890400001@xuper"}' --account XC1234567890200001@xuper
...
xchain-cli wasm invoke video --method list_merit -a '{"id":"xxx"}' --account XC1234567890200001@xuper
xchain-cli wasm invoke video --method list_merit --account XC1234567890200001@xuper
...
xchain-cli wasm invoke video --method list_meritranking --account XC1234567890200001@xuper
xchain-cli wasm invoke video --method list_meritranking -a '{"id":""}' --account XC1234567890200001@xuper
xchain-cli wasm invoke video --method list_meritranking -a '{"id":"XC1234567890400001@xuper"}' --account XC1234567890200001@xuper
