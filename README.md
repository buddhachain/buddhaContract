...
xchain-cli wasm invoke --fee 1000000 exchange --method productfind -a '{"id":"1"}' --account XC1234567890222222@xuper
...
xchain-cli wasm invoke --fee 1000000 exchange --method buy -a '{"id": "1","product_size":"3","products":"[\"1\",\"2\",\"3\"]"}'
