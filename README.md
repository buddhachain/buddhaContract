...
xchain-cli wasm invoke --fee 1000000 exchange --method productfind -a '{"id":"1"}' --account XC1234567890111111@xuper
xchain-cli wasm invoke --fee 1000000 exchange --method scan -a '{"id":"1"}'
xchain-cli wasm invoke --fee 1000000 exchange --method productadd -a '{"id": "1", "name":"prodname","desc":"proddesc","price":"5", "amount":"6","time":"7"}' --account XC1234567890111111@xuper
xchain-cli wasm invoke --fee 1000000 exchange --method productdel -a '{"id": "1"}'  --account XC1234567890111111@xuper
xchain-cli wasm invoke --fee 1000000 exchange --method buy -a '{"id": "1","products":"[{\"id\":\"1\",\"count\":\"1\"},{\"id\":\"1\",\"count\":\"2\"},{\"id\":\"1\",\"count\":\"3\"}]","price":"29"}'
