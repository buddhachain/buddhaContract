...
xchain-cli wasm invoke book --method approve_log -a '{"id":"XC1234567890400001@xuper"}' --account XC1234567890200001@xuper
xchain-cli wasm invoke book --method is_log --account XC1234567890400001@xuper
xchain-cli wasm invoke book --method list_log --account XC1234567890200001@xuper

xchain-cli wasm invoke book --method recusal_log -a '{"id":"XC1234567890400001@xuper"}' --account XC1234567890200001@xuper
```
