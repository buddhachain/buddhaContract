...
xchain-cli wasm invoke book --method approve_guaranty -a '{"id":"XC1234567890300001@xuper"}' --account XC1234567890200001@xuper
xchain-cli wasm invoke book --method is_guaranty --account XC1234567890300001@xuper
xchain-cli wasm invoke book --method list_guaranty --account XC1234567890200001@xuper

xchain-cli wasm invoke book --method recusal_guaranty -a '{"id":"XC1234567890300001@xuper"}' --account XC1234567890200001@xuper
```
