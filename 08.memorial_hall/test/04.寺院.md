...
xchain-cli wasm invoke memorial_hall --method approve_guaranty -a '{"id":"XC1234567890300001@xuper"}' --account XC1234567890200001@xuper
xchain-cli wasm invoke memorial_hall --method is_guaranty --account XC1234567890300001@xuper
xchain-cli wasm invoke memorial_hall --method list_guaranty --account XC1234567890200001@xuper

xchain-cli wasm invoke memorial_hall --method recusal_guaranty -a '{"id":"XC1234567890300001@xuper"}' --account XC1234567890200001@xuper
```
